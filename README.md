...
- *Data/*
	...
	- `SpatialDataset` folder contains the full package of the shapefile generated by importing `FullDatasetNew.xlsx` to ArcGIS. In the folder, `SpatialDataset.shp` was imported to R to calculate Spatial Lag Regression. 
